...
public class LoadUnitController {
    ...
    @PostMapping
    public ResponseEntity<LoadUnitResponse> createLoadUnit(@RequestBody @Valid LoadUnitRequest request) {
    ...
    public ResponseEntity<Page<LoadUnitResponse>> findAll(
        ...
        log.info("REST request to get all Load Units (Page size: {}, Page number: {})",
