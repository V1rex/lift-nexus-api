...
public interface TransportOrderRepository extends JpaRepository<TransportOrder, Long> {
    ...
    // Notice the underscore: it navigates the relationship to LoadUnit automatically
    ...
    """)
    Page<TransportOrder> searchOrders(@Param("status") TransportOrderStatus status,
