...
public class TransportOrderController {
    ...
    @PostMapping
    public ResponseEntity<TransportOrderResponse> createOrder(@RequestBody @Valid TransportOrderRequest request) {
    ...
    public ResponseEntity<TransportOrderResponse> updateOrderStatus(
            ...
            @RequestBody @Valid TransportOrderStatusUpdateRequest request) {
