...
public class ForkliftTravelDistanceConstraint {
    ...
    public static Constraint forkliftTravelDistance(ConstraintFactory factory) {
      return factory
          ...
          .filter(forklift -> forklift.getTransportOrders() != null && !forklift.getTransportOrders().isEmpty())
          .penalize(HardSoftScore.ONE_SOFT,
                  ForkliftTravelDistanceConstraint::calculateTotalTravelDistance)
    ...
    private static int calculateTotalTravelDistance(Forklift forklift) {
        ...
        Coordinate3D currentLocationForklift = forklift
                                                                            .getCurrentStorageBin()
                                                                            .getCoordinate();
