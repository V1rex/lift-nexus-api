...
public enum StorageBinErrorCode implements ErrorCode {
  ...
  STORAGE_BIN_NOT_FOUND("storage_bin_not_found",
      "Storage Bin Not Found",
      HttpStatus.NOT_FOUND),

  STORAGE_BIN_CODE_EXISTS("storage_bin_code_already_exists",
      "Storage Bin Code Already Exists",
      HttpStatus.CONFLICT);
