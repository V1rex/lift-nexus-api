...
public class ForkliftController {
    ...
    @PostMapping
    public ResponseEntity<ForkliftResponse> createForklift(@RequestBody @Valid ForkliftRequest request) {
    ...
    public ResponseEntity<ForkliftResponse> updateForkliftLocation(
        ...
        return ResponseEntity.ok(forkliftService.updateForkliftLocation(id, updateRequest.locationId()));
    }

    @PatchMapping("/{id}/status")
    public ResponseEntity<ForkliftResponse> updateOperationalStatus(
            @PathVariable Long id,
            @RequestParam OperationalStatus status) {
