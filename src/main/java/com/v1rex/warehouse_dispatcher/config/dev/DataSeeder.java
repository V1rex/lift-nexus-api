package com.v1rex.warehouse_dispatcher.config.dev;
...
public class DataSeeder implements CommandLineRunner{
    ...
    public void run(String... args) {
        ...
        Forklift heavyTruck = Forklift.builder()
                .weightCapacity(5000)
                .equipmentType(EquipmentType.SIDE_LOADER)
                .currentLocation(dock)
                .build();

        Forklift reachTruck = Forklift.builder()
                .weightCapacity(2000)
        ...
        log.info("Seeding complete: {} Locations, {} Forklifts, {} Tasks.",
