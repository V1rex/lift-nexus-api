...
"New entities mapped from a request should not have an ID yet");
            ...
            assertEquals(EquipmentType.STANDARD,
    ...
    class ToResponseTests {
        @Test
        @DisplayName("Should correctly map " +
                "Forklift Entity to ForkliftResponse DTO")
        void shouldMapEntityToResponse() {
            ...
            when(taskMapper.toResponse(mockTask1)).thenReturn(
                    new TaskResponse(1L,
                            null,
                            null,
                            10,
            ...
            when(taskMapper.toResponse(mockTask2)).thenReturn(
            new TaskResponse(2L,
                            null,
                            null,
                            5,
            ...
            Forklift entity = Forklift.builder()
                    .id(42L)
                    .weightCapacity(1)
            ...
            assertEquals(99L,
                    response.currentLocation().id());
            assertEquals(51.5136F,
                    response.currentLocation().latitude());
            assertEquals(7.4653F,
