...
public class ForkliftServiceTest {
    ...
    class CreateForklift{
        ...
        void createForklift_ShouldReturnResponse_WhenRequestIsValid(){
            ForkliftRequest forkliftRequest = new
                    ForkliftRequest(1000, EquipmentType.STANDARD);
            ...
            when(forkliftRepository.save(any(Forklift.class)))
                    .thenReturn(savedForklift);

            ForkliftResponse mockResponse = new ForkliftResponse(1L,
                    1000,
    ...
    class FindForkliftById{
        ...
        void findById_ShouldReturnResponse_WhenForkliftExists() {
            ...
            ForkliftResponse mockResponse = new ForkliftResponse(forkliftId,
                    1000,
                    EquipmentType.STANDARD,
                    null,
                    null);
    ...
    class FindAllForklifts{
        ...
        void findAll_ShouldReturnPage_WhenCalled() {
            ...
            Page<Forklift> mockPage = new org.springframework.data.domain.PageImpl<>(java.util.List.of(forklift));
    ...
    class FindForkliftsWithCapacityGreaterThan{
        ...
        void findWithCapacityGreaterThan_ShouldReturnPage_WhenCriteriaIsValid() {
            ...
            Page<Forklift> mockPage = new org.springframework.data.domain.PageImpl<>(
                    java.util.List.of(forklift1, forklift2));

            when(forkliftRepository.findByWeightCapacityGreaterThan(weightCapacity, pageable))
                    .thenReturn(mockPage);

            ForkliftResponse response1 = new ForkliftResponse(1L,
                    1000,
                    EquipmentType.STANDARD,
                    null,
                    null);

            ForkliftResponse response2 = new ForkliftResponse(2L,
                    1500,
            ...
            Page<ForkliftResponse> result = forkliftService.findWithCapacityGreaterThan(weightCapacity, pageable);
            ...
            verify(forkliftRepository, times(1)).findByWeightCapacityGreaterThan(weightCapacity, pageable);
        }
    }
    ...
    class UpdateForkliftLocation{
        ...
        @Test
        @DisplayName("Should successfully update forklift location when both forklift and location exist")
        void updateForkliftLocation_ShouldReturnResponse_WhenBothExist() {
            ...
            LocationResponse locationResponse = new LocationResponse(locationId,
                    40.71F,
                    -74.07F);
