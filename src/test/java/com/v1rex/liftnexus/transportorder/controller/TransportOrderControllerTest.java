...
class TransportOrderControllerTest {
    ...
    when(transportOrderService.findById(1L))
      .thenReturn(response);
    ...
    .createTransportOrder(any(TransportOrderRequest.class)))
    .thenReturn(response);
    ...
    .andExpect(header().string("Location",
          containsString("/api/v1/transport-orders/42")))
    ...
    TransportOrderRequest invalidRequest = new
