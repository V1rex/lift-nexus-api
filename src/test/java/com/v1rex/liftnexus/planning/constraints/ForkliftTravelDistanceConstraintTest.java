...
public class ForkliftTravelDistanceConstraintTest {
    private ConstraintVerifier<ForkliftTravelDistanceTestConstraintProvider, WarehouseSchedule> constraintVerifier;
     ...
     void forkliftTravelDistance_shouldNotPenalize_WhenEmptyTransportOrders(){
         constraintVerifier.verifyThat(ForkliftTravelDistanceTestConstraintProvider::forkliftTravelDistance)
             .given(mockForklift)
             .penalizesBy(0);
     }
    ...
    @Test
    @DisplayName("Forklift travel distance should penalize sequentially when more than one transport order is assigned")
    void forkliftTravelDistance_shouldPenalize_WhenMoreThanOneTransportOrder() {

        LoadUnit mockLoad1 = LoadUnit.builder()
                .id(1L)
                .trackingCode("MOCK-LOAD-001")
                .weightKg(500)
                .status(LoadUnitStatus.STAGED)
        ...
        StorageBin targetDock1 = StorageBin.builder()
                .id(2L)
                .binCode("DOCK-02")
                .coordinate(new Coordinate3D(10, 0, 0))
                .zoneType(ZoneType.STAGING_OUT)
        ...
        TransportOrder order1 = TransportOrder.builder()
                .id(1L)
                .sourceBin(mockForklift.getCurrentStorageBin())
        ...
        StorageBin sourceBin2 = StorageBin.builder()
                .id(3L)
                .binCode("AISLE-A-01")
        ...
        StorageBin targetBin2 = StorageBin.builder()
                .id(4L)
                .binCode("AISLE-A-12")
        ...
        LoadUnit mockLoad2 = LoadUnit.builder()
                .id(2L)
        ...
        TransportOrder order2 = TransportOrder.builder()
                .id(2L)
