...
class LoadUnitMapperTest {
    ...
    void shouldMapRequestToEntity() {
        LoadUnitRequest request = new
                LoadUnitRequest("LU-MAPPED-1",
                450,
                LoadUnitStatus.EXPECTED,
                10L);
        StorageBin mockBin = StorageBin
                                                .builder()
                                                .id(10L)
                                                .binCode("BIN-A-01")
                                                .build();
        ...
        assertThat(result.getTrackingCode())
                .isEqualTo("LU-MAPPED-1");
        assertThat(result.getWeightKg())
                .isEqualTo(450);
        assertThat(result.getStatus())
                .isEqualTo(LoadUnitStatus.EXPECTED);
        assertThat(result.getCurrentBin())
                .isEqualTo(mockBin);
    ...
    void shouldMapEntityToResponse() {
        StorageBin mockBin = StorageBin
                                                ...
                                                .binCode("BIN-C-05")
                                                .build();
        LoadUnit entity = LoadUnit.builder()
                .id(1L)
        ...
        assertThat(response.id())
                .isEqualTo(1L);
        assertThat(response.trackingCode())
                .isEqualTo("LU-ENTITY-1");
        assertThat(response.weightKg())
                .isEqualTo(1200);
        assertThat(response.status())
                .isEqualTo(LoadUnitStatus.STORED);
        assertThat(response.currentStorageBinId())
                .isEqualTo(25L);
    ...
    @Test
    @DisplayName("Should gracefully map null inputs or null references without throwing NullPointerExceptions")
    void shouldHandleNullReferencesGracefully() {
        assertThat(mapper.toEntity(null, null)).isNull();
        assertThat(mapper.toResponse(null)).isNull();

        LoadUnit partialEntity = LoadUnit.builder()
                .id(5L)
