...
public class LocationServiceTest {
    ...
    class CreateLocation{
        ...
        void createLocation_ShouldReturnResponse_WhenRequestIsValid(){
            ...
            LocationResponse mockResponse = new
                    LocationResponse(1L,
                    40.71F,
                    -74.07F);
    ...
    class FindAllLocations{
        ...
        void findAll_ShouldReturnPage_WhenCalled() {
            ...
            Location location = new Location();
            location.setId(1L);
            Page<Location> mockPage = new org.springframework.data.domain.PageImpl<>(java.util.List.of(location));
